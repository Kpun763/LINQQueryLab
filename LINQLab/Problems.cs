    ...
    class Problems
    {
        ...
        */
        ...
        public void RProblemFive()
        {
            ...
            // Then print each user's email and registration date to the console.
            var usersBetween2016And2018 = _context.Users
                .Where(u => u.RegistrationDate > new DateTime(2016,1,1))
                .Where(u => u.RegistrationDate < new DateTime(2018,1,1));

            Console.WriteLine();
            Console.WriteLine("RProblemFive: Each user who registered afte 2016 and before 2018");
        ...
        public void RProblemSix()
        {
            ...
            var userShoppingCart = _context.ShoppingCartItems.Include(sci => sci.Product).Where(sci => sci.User.Email == "afton@gmail.com");

            Console.WriteLine("RProlemSix: Shopping cart items of user with afton email");
            foreach (ShoppingCartItem shoppingcartitem in userShoppingCart)
            {
                Console.WriteLine($"Product name: {shoppingcartitem.Product.Name}, Product price: {shoppingcartitem.Product.Price}, Quantity: {shoppingcartitem.Quantity}");
            }
        ...
        */
        ...
        public void RProblemSeven()
        {
            ...
            var newuserShoppingCart = _context.ShoppingCartItems.Include(sci => sci.Product).Where(sci => sci.User.Email == "oda@gmail.com").Select(sci => sci.Product.Price).Sum();
            Console.WriteLine();
            Console.WriteLine("RProblemSeven: Price of all shopping cart items of user with oda email");
            Console.WriteLine($"Total Price: {newuserShoppingCart}");
        }
        /*
         Total: $715.34
         */
        ...
        private void CProblemOne()
        {
            ...
            Product newProduct = new Product()
            {
                Id = 8,
                Name = "Playstation 5",
                Description = "A new gaming system by Sony",
                Price = 399.00M
            };
